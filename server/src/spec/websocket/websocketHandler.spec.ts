...
describe('WsHandler', () => {
  ...
  beforeEach(async () => {
    ...
    USER2 = 'user2';
    ROOMID = '1';
    RACEINFO1 = {roomId: ROOMID, hasStarted: false, isPublic: true, start: new Date(), passage: "TODO", users: [USER1]};
    RACEINFOFULL1 = {roomId: ROOMID, hasStarted: false, isPublic: true, start: new Date(), passage: "TODO", users: [USER1, USER2]};
